...
Original file is located at
    https://colab.research.google.com/drive/14lA9ONsOsEyGsCzq57acZWAGC-3pgLSA
"""
...
def get_scatter_chart(entered_site, value):
    ...
    filtered_df = filtered_df[(filtered_df['Payload Mass (kg)'] > value[0]) & (filtered_df['Payload Mass (kg)'] <= value[1])]
    if entered_site == 'ALL':
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Launch Site', title='ALL')
        return fig 
    else:
